...
if (isset($_POST['addTable'])) {
    ...
    $quet="INSERT INTO `tables`(`table_no`, `no_of_seat`, `availability`, `table_type`) VALUES ('$tableno','$lname','$password','$email','$phone','$address','$city','$country','$postal_code','$about')" ;
    mysqli_query($con, $quet);
    header('location:manageTables.html');
}
?>