  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
      ...
      <ul class="nav">
          ...
          <li>
            <a href="./updateMeals.php">
              <i class="nc-icon nc-settings"></i>
              <p>Update Meals Menu</p>
            </a>
          </li>
          <li>
            <a href="./updateDrinks.php">
              <i class="nc-icon nc-settings"></i>
              <p>Update Drinks Menu</p>
            </a>
          </li>
          <li class="active">
            <a href="./manageTables.php">
              <i class="nc-icon nc-tile-56"></i>
              <p>Manage Tables</p>
            </a>
          </li>
          <li>
            <a href="./addBarista.html">
                ...
                <div class="places-buttons">
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      ?>
                            <h2 class="btn btn-warning"><?php echo $rows['table_no']; ?></h2>
                      <?php
                          }
                        }
                      ?>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <div class="places-buttons">
                  <h3 class="mb-0" style="text-align: center;">Add New Tables</h3>
                  <form class="col-md-3 ml-auto mr-auto" method="POST" action="updateItem.php">
